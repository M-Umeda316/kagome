"""ASE Calculator adapter: wraps any ASE Calculator for use with kagome.
...
class ASECalculatorAdapter(Calculator):
    """Wraps an ASE Calculator to provide kagome's Calculator interface.

    Handles unit conversion: ASE uses eV/Å, kagome uses kcal/mol/Å.
    """
